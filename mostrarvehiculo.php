...
while($row = mysqli_fetch_array($result)) { printf("<tr><td>%s </td><td>%s </td><td>%s </td><td>%s </td><td>%s </td><td>%s </td><td>%s </td></tr><br/>",
$row["matricula"],$row["marca"],$row["modelo"],$row["color"],$row["telefono"],$row["motivo"],$row["observaciones"]); }
?>
