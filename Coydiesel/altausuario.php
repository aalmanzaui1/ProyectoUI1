...
$datos=$_POST['usuario'];
$con= Conectarse();
$query= "INSERT INTO cliente(nombre,direccion,telefono,correo,pass,matricula) VALUES ('".$datos["nombre"]."','".$datos['direccion']."','".$datos['telefono']."','".$datos['correo']."','".$datos['contrasenia']."','".$datos['matricula']."');";
//print_r($query);
